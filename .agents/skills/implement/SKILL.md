...
4. Run `pnpm check`. Load [code-review](../code-review/SKILL.md), supplying the starting revision, baseline worktree state, owned files/hunks, and ticket/spec path. Review the actual current changes, including staged, unstaged, and relevant untracked content, even if nothing has been committed.
